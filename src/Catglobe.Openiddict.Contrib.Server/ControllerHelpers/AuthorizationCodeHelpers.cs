...
public static class AuthorizationCodeHelpers
{
   ...
   public static IActionResult? ReAuthenticateIfNecessary(this AuthenticateResult result, OpenIddictRequest request, ControllerBase controller)
   {
   ...
   public static ForbidResult ForbidOpenIddict(this ControllerBase controller, string errorType, string errorText) =>
   ...
   public static OpenIddictRequest GetOpenIddictServerRequest(this ControllerBase controller) =>
